...
test.describe('文件操作测试', () => {
  ...
  test('完整的编辑和保存流程', async ({ page }) => {
    ...
    // 2. 编辑内容
    await editor.type('# 我的文档')
    await page.keyboard.press('Enter')
    await page.keyboard.press('Enter')
    await editor.type('这是第一段内容')
